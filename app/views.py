import os
import cv2
from app.PipelineModel import FaceRecog
...
def app():
    if request.method == 'POST':
        ...
        # get predictions
        pred_image, predictions = FaceRecog(path)
        ...
        return render_template('app.html',fileupload=True,report=report) # POST REQUEST
            
    
    
    return render_template('app.html',fileupload=False) # GET REQUEST